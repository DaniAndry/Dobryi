...
Deserializers["UnityEngine.UI.Button"] = function (request, data, root) {
  var i2678 = root || request.c( 'UnityEngine.UI.Button' )
  var i2679 = data
  i2678.m_OnClick = request.d('UnityEngine.UI.Button+ButtonClickedEvent', i2679[0], i2678.m_OnClick)
  i2678.m_Navigation = request.d('UnityEngine.UI.Navigation', i2679[1], i2678.m_Navigation)
  i2678.m_Transition = i2679[2]
  i2678.m_Colors = request.d('UnityEngine.UI.ColorBlock', i2679[3], i2678.m_Colors)
  i2678.m_SpriteState = request.d('UnityEngine.UI.SpriteState', i2679[4], i2678.m_SpriteState)
  i2678.m_AnimationTriggers = request.d('UnityEngine.UI.AnimationTriggers', i2679[5], i2678.m_AnimationTriggers)
  i2678.m_Interactable = !!i2679[6]
  request.r(i2679[7], i2679[8], 0, i2678, 'm_TargetGraphic')
  return i2678
}

Deserializers["UnityEngine.UI.Button+ButtonClickedEvent"] = function (request, data, root) {
  var i2680 = root || request.c( 'UnityEngine.UI.Button+ButtonClickedEvent' )
  var i2681 = data
  i2680.m_PersistentCalls = request.d('UnityEngine.Events.PersistentCallGroup', i2681[0], i2680.m_PersistentCalls)
  return i2680
}

Deserializers["UnityEngine.Events.PersistentCallGroup"] = function (request, data, root) {
  var i2682 = root || request.c( 'UnityEngine.Events.PersistentCallGroup' )
  var i2683 = data
  var i2685 = i2683[0]
  var i2684 = new (System.Collections.Generic.List$1(Bridge.ns('UnityEngine.Events.PersistentCall')))
  for(var i = 0; i < i2685.length; i += 1) {
    i2684.add(request.d('UnityEngine.Events.PersistentCall', i2685[i + 0]));
  }
  i2682.m_Calls = i2684
  return i2682
}
...
Deserializers["UnityEngine.Events.PersistentCall"] = function (request, data, root) {
  var i2688 = root || request.c( 'UnityEngine.Events.PersistentCall' )
  var i2689 = data
  request.r(i2689[0], i2689[1], 0, i2688, 'm_Target')
  i2688.m_TargetAssemblyTypeName = i2689[2]
  i2688.m_MethodName = i2689[3]
  i2688.m_Mode = i2689[4]
  i2688.m_Arguments = request.d('UnityEngine.Events.ArgumentCache', i2689[5], i2688.m_Arguments)
  i2688.m_CallState = i2689[6]
  return i2688
}

Deserializers["UnityEngine.Events.ArgumentCache"] = function (request, data, root) {
  var i2690 = root || request.c( 'UnityEngine.Events.ArgumentCache' )
  var i2691 = data
  request.r(i2691[0], i2691[1], 0, i2690, 'm_ObjectArgument')
  i2690.m_ObjectArgumentAssemblyTypeName = i2691[2]
  i2690.m_IntArgument = i2691[3]
  i2690.m_FloatArgument = i2691[4]
  i2690.m_StringArgument = i2691[5]
  i2690.m_BoolArgument = !!i2691[6]
  return i2690
}

Deserializers["UnityEngine.UI.Navigation"] = function (request, data, root) {
  var i2692 = root || request.c( 'UnityEngine.UI.Navigation' )
  var i2693 = data
  i2692.m_Mode = i2693[0]
  i2692.m_WrapAround = !!i2693[1]
  request.r(i2693[2], i2693[3], 0, i2692, 'm_SelectOnUp')
  request.r(i2693[4], i2693[5], 0, i2692, 'm_SelectOnDown')
  request.r(i2693[6], i2693[7], 0, i2692, 'm_SelectOnLeft')
  request.r(i2693[8], i2693[9], 0, i2692, 'm_SelectOnRight')
  return i2692
}

Deserializers["UnityEngine.UI.ColorBlock"] = function (request, data, root) {
  var i2694 = root || request.c( 'UnityEngine.UI.ColorBlock' )
  var i2695 = data
  i2694.m_NormalColor = new pc.Color(i2695[0], i2695[1], i2695[2], i2695[3])
  i2694.m_HighlightedColor = new pc.Color(i2695[4], i2695[5], i2695[6], i2695[7])
  i2694.m_PressedColor = new pc.Color(i2695[8], i2695[9], i2695[10], i2695[11])
  i2694.m_SelectedColor = new pc.Color(i2695[12], i2695[13], i2695[14], i2695[15])
  i2694.m_DisabledColor = new pc.Color(i2695[16], i2695[17], i2695[18], i2695[19])
  i2694.m_ColorMultiplier = i2695[20]
  i2694.m_FadeDuration = i2695[21]
  return i2694
}

Deserializers["UnityEngine.UI.SpriteState"] = function (request, data, root) {
  var i2696 = root || request.c( 'UnityEngine.UI.SpriteState' )
  var i2697 = data
  request.r(i2697[0], i2697[1], 0, i2696, 'm_HighlightedSprite')
  request.r(i2697[2], i2697[3], 0, i2696, 'm_PressedSprite')
  request.r(i2697[4], i2697[5], 0, i2696, 'm_SelectedSprite')
  request.r(i2697[6], i2697[7], 0, i2696, 'm_DisabledSprite')
  return i2696
}

Deserializers["UnityEngine.UI.AnimationTriggers"] = function (request, data, root) {
  var i2698 = root || request.c( 'UnityEngine.UI.AnimationTriggers' )
  var i2699 = data
  i2698.m_NormalTrigger = i2699[0]
  i2698.m_HighlightedTrigger = i2699[1]
  i2698.m_PressedTrigger = i2699[2]
  i2698.m_SelectedTrigger = i2699[3]
  i2698.m_DisabledTrigger = i2699[4]
  return i2698
}

Deserializers["TMPro.TextMeshProUGUI"] = function (request, data, root) {
  var i2700 = root || request.c( 'TMPro.TextMeshProUGUI' )
  var i2701 = data
  i2700.m_hasFontAssetChanged = !!i2701[0]
  request.r(i2701[1], i2701[2], 0, i2700, 'm_baseMaterial')
  i2700.m_maskOffset = new pc.Vec4( i2701[3], i2701[4], i2701[5], i2701[6] )
  i2700.m_text = i2701[7]
  i2700.m_isRightToLeft = !!i2701[8]
  request.r(i2701[9], i2701[10], 0, i2700, 'm_fontAsset')
  request.r(i2701[11], i2701[12], 0, i2700, 'm_sharedMaterial')
  var i2703 = i2701[13]
  var i2702 = []
  for(var i = 0; i < i2703.length; i += 2) {
  request.r(i2703[i + 0], i2703[i + 1], 2, i2702, '')
  }
  i2700.m_fontSharedMaterials = i2702
  request.r(i2701[14], i2701[15], 0, i2700, 'm_fontMaterial')
  var i2705 = i2701[16]
  var i2704 = []
  for(var i = 0; i < i2705.length; i += 2) {
  request.r(i2705[i + 0], i2705[i + 1], 2, i2704, '')
  }
  i2700.m_fontMaterials = i2704
  i2700.m_fontColor32 = UnityEngine.Color32.ConstructColor(i2701[17], i2701[18], i2701[19], i2701[20])
  i2700.m_fontColor = new pc.Color(i2701[21], i2701[22], i2701[23], i2701[24])
  i2700.m_enableVertexGradient = !!i2701[25]
  i2700.m_colorMode = i2701[26]
  i2700.m_fontColorGradient = request.d('TMPro.VertexGradient', i2701[27], i2700.m_fontColorGradient)
  request.r(i2701[28], i2701[29], 0, i2700, 'm_fontColorGradientPreset')
  request.r(i2701[30], i2701[31], 0, i2700, 'm_spriteAsset')
  i2700.m_tintAllSprites = !!i2701[32]
  request.r(i2701[33], i2701[34], 0, i2700, 'm_StyleSheet')
  i2700.m_TextStyleHashCode = i2701[35]
  i2700.m_overrideHtmlColors = !!i2701[36]
  i2700.m_faceColor = UnityEngine.Color32.ConstructColor(i2701[37], i2701[38], i2701[39], i2701[40])
  i2700.m_fontSize = i2701[41]
  i2700.m_fontSizeBase = i2701[42]
  i2700.m_fontWeight = i2701[43]
  i2700.m_enableAutoSizing = !!i2701[44]
  i2700.m_fontSizeMin = i2701[45]
  i2700.m_fontSizeMax = i2701[46]
  i2700.m_fontStyle = i2701[47]
  i2700.m_HorizontalAlignment = i2701[48]
  i2700.m_VerticalAlignment = i2701[49]
  i2700.m_textAlignment = i2701[50]
  i2700.m_characterSpacing = i2701[51]
  i2700.m_wordSpacing = i2701[52]
  i2700.m_lineSpacing = i2701[53]
  i2700.m_lineSpacingMax = i2701[54]
  i2700.m_paragraphSpacing = i2701[55]
  i2700.m_charWidthMaxAdj = i2701[56]
  i2700.m_enableWordWrapping = !!i2701[57]
  i2700.m_wordWrappingRatios = i2701[58]
  i2700.m_overflowMode = i2701[59]
  request.r(i2701[60], i2701[61], 0, i2700, 'm_linkedTextComponent')
  request.r(i2701[62], i2701[63], 0, i2700, 'parentLinkedComponent')
  i2700.m_enableKerning = !!i2701[64]
  i2700.m_enableExtraPadding = !!i2701[65]
  i2700.checkPaddingRequired = !!i2701[66]
  i2700.m_isRichText = !!i2701[67]
  i2700.m_parseCtrlCharacters = !!i2701[68]
  i2700.m_isOrthographic = !!i2701[69]
  i2700.m_isCullingEnabled = !!i2701[70]
  i2700.m_horizontalMapping = i2701[71]
  i2700.m_verticalMapping = i2701[72]
  i2700.m_uvLineOffset = i2701[73]
  i2700.m_geometrySortingOrder = i2701[74]
  i2700.m_IsTextObjectScaleStatic = !!i2701[75]
  i2700.m_VertexBufferAutoSizeReduction = !!i2701[76]
  i2700.m_useMaxVisibleDescender = !!i2701[77]
  i2700.m_pageToDisplay = i2701[78]
  i2700.m_margin = new pc.Vec4( i2701[79], i2701[80], i2701[81], i2701[82] )
  i2700.m_isUsingLegacyAnimationComponent = !!i2701[83]
  i2700.m_isVolumetricText = !!i2701[84]
  request.r(i2701[85], i2701[86], 0, i2700, 'm_Material')
  i2700.m_Maskable = !!i2701[87]
  i2700.m_Color = new pc.Color(i2701[88], i2701[89], i2701[90], i2701[91])
  i2700.m_RaycastTarget = !!i2701[92]
  i2700.m_RaycastPadding = new pc.Vec4( i2701[93], i2701[94], i2701[95], i2701[96] )
  return i2700
}

Deserializers["TMPro.VertexGradient"] = function (request, data, root) {
  var i2708 = root || request.c( 'TMPro.VertexGradient' )
  var i2709 = data
  i2708.topLeft = new pc.Color(i2709[0], i2709[1], i2709[2], i2709[3])
  i2708.topRight = new pc.Color(i2709[4], i2709[5], i2709[6], i2709[7])
  i2708.bottomLeft = new pc.Color(i2709[8], i2709[9], i2709[10], i2709[11])
  i2708.bottomRight = new pc.Color(i2709[12], i2709[13], i2709[14], i2709[15])
  return i2708
}

Deserializers["Luna.Unity.DTO.UnityEngine.Scene.Scene"] = function (request, data, root) {
  var i2710 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Scene.Scene' )
  var i2711 = data
  i2710.name = i2711[0]
  i2710.index = i2711[1]
  i2710.startup = !!i2711[2]
  return i2710
}

Deserializers["Luna.Unity.DTO.UnityEngine.Components.Transform"] = function (request, data, root) {
  var i2712 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Components.Transform' )
  var i2713 = data
  i2712.position = new pc.Vec3( i2713[0], i2713[1], i2713[2] )
  i2712.scale = new pc.Vec3( i2713[3], i2713[4], i2713[5] )
  i2712.rotation = new pc.Quat(i2713[6], i2713[7], i2713[8], i2713[9])
  return i2712
}

Deserializers["Luna.Unity.DTO.UnityEngine.Components.Camera"] = function (request, data, root) {
  var i2714 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Components.Camera' )
  var i2715 = data
  i2714.enabled = !!i2715[0]
  i2714.aspect = i2715[1]
  i2714.orthographic = !!i2715[2]
  i2714.orthographicSize = i2715[3]
  i2714.backgroundColor = new pc.Color(i2715[4], i2715[5], i2715[6], i2715[7])
  i2714.nearClipPlane = i2715[8]
  i2714.farClipPlane = i2715[9]
  i2714.fieldOfView = i2715[10]
  i2714.depth = i2715[11]
  i2714.clearFlags = i2715[12]
  i2714.cullingMask = i2715[13]
  i2714.rect = i2715[14]
  request.r(i2715[15], i2715[16], 0, i2714, 'targetTexture')
  i2714.usePhysicalProperties = !!i2715[17]
  i2714.focalLength = i2715[18]
  i2714.sensorSize = new pc.Vec2( i2715[19], i2715[20] )
  i2714.lensShift = new pc.Vec2( i2715[21], i2715[22] )
  i2714.gateFit = i2715[23]
  i2714.commandBufferCount = i2715[24]
  i2714.cameraType = i2715[25]
  return i2714
}
...
Deserializers["Bank"] = function (request, data, root) {
  var i2722 = root || request.c( 'Bank' )
  var i2723 = data
  request.r(i2723[0], i2723[1], 0, i2722, 'BuyBigCupButton')
  request.r(i2723[2], i2723[3], 0, i2722, 'BigCupButton')
  request.r(i2723[4], i2723[5], 0, i2722, 'MiddleCupButton')
  request.r(i2723[6], i2723[7], 0, i2722, 'MoneyText')
  request.r(i2723[8], i2723[9], 0, i2722, 'Tutorial')
  request.r(i2723[10], i2723[11], 0, i2722, 'BuyAdditiveButton')
  request.r(i2723[12], i2723[13], 0, i2722, 'BuyJuiceButton')
  request.r(i2723[14], i2723[15], 0, i2722, 'JuiceButton1')
  request.r(i2723[16], i2723[17], 0, i2722, 'JuiceButton2')
  request.r(i2723[18], i2723[19], 0, i2722, 'JuiceButton3')
  request.r(i2723[20], i2723[21], 0, i2722, 'Additive1Button')
  request.r(i2723[22], i2723[23], 0, i2722, 'Additive2Button')
  i2722.Money = i2723[24]
  i2722.IsBigCupBuy = !!i2723[25]
  i2722.IsJuiceBuy = !!i2723[26]
  i2722.IsAdditiveBuy = !!i2723[27]
  request.r(i2723[28], i2723[29], 0, i2722, '_buySound')
  return i2722
}

Deserializers["Luna.Unity.DTO.UnityEngine.Components.Canvas"] = function (request, data, root) {
  var i2724 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Components.Canvas' )
  var i2725 = data
  i2724.enabled = !!i2725[0]
  i2724.planeDistance = i2725[1]
  i2724.referencePixelsPerUnit = i2725[2]
  i2724.isFallbackOverlay = !!i2725[3]
  i2724.renderMode = i2725[4]
  i2724.renderOrder = i2725[5]
  i2724.sortingLayerName = i2725[6]
  i2724.sortingOrder = i2725[7]
  i2724.scaleFactor = i2725[8]
  request.r(i2725[9], i2725[10], 0, i2724, 'worldCamera')
  i2724.overrideSorting = !!i2725[11]
  i2724.pixelPerfect = !!i2725[12]
  i2724.targetDisplay = i2725[13]
  i2724.overridePixelPerfect = !!i2725[14]
  return i2724
}

Deserializers["UnityEngine.UI.CanvasScaler"] = function (request, data, root) {
  var i2726 = root || request.c( 'UnityEngine.UI.CanvasScaler' )
  var i2727 = data
  i2726.m_UiScaleMode = i2727[0]
  i2726.m_ReferencePixelsPerUnit = i2727[1]
  i2726.m_ScaleFactor = i2727[2]
  i2726.m_ReferenceResolution = new pc.Vec2( i2727[3], i2727[4] )
  i2726.m_ScreenMatchMode = i2727[5]
  i2726.m_MatchWidthOrHeight = i2727[6]
  i2726.m_PhysicalUnit = i2727[7]
  i2726.m_FallbackScreenDPI = i2727[8]
  i2726.m_DefaultSpriteDPI = i2727[9]
  i2726.m_DynamicPixelsPerUnit = i2727[10]
  i2726.m_PresetInfoIsWorld = !!i2727[11]
  return i2726
}

Deserializers["UnityEngine.UI.GraphicRaycaster"] = function (request, data, root) {
  var i2728 = root || request.c( 'UnityEngine.UI.GraphicRaycaster' )
  var i2729 = data
  i2728.m_IgnoreReversedGraphics = !!i2729[0]
  i2728.m_BlockingObjects = i2729[1]
  i2728.m_BlockingMask = UnityEngine.LayerMask.FromIntegerValue( i2729[2] )
  return i2728
}

Deserializers["ImageShiftOnOrientation"] = function (request, data, root) {
  var i2730 = root || request.c( 'ImageShiftOnOrientation' )
  var i2731 = data
  var i2733 = i2731[0]
  var i2732 = []
  for(var i = 0; i < i2733.length; i += 1) {
    i2732.push( request.d('ItemSwitcherData', i2733[i + 0]) );
  }
  i2730.Items = i2732
  request.r(i2731[1], i2731[2], 0, i2730, '_backHorizontal')
  request.r(i2731[3], i2731[4], 0, i2730, '_backVertical')
  request.r(i2731[5], i2731[6], 0, i2730, '_tableHorizontal')
  request.r(i2731[7], i2731[8], 0, i2730, '_tableVertical')
  i2730.IsDebug = !!i2731[9]
  i2730.CanCopy = !!i2731[10]
  return i2730
}

Deserializers["ItemSwitcherData"] = function (request, data, root) {
  var i2736 = root || request.c( 'ItemSwitcherData' )
  var i2737 = data
  request.r(i2737[0], i2737[1], 0, i2736, 'Target')
  i2736.HorizontalAnchoredPosition = new pc.Vec2( i2737[2], i2737[3] )
  i2736.SizeHorizontal = new pc.Vec2( i2737[4], i2737[5] )
  i2736.VerticalAnchoredPosition = new pc.Vec2( i2737[6], i2737[7] )
  i2736.SizeVertical = new pc.Vec2( i2737[8], i2737[9] )
  i2736.MinHorizontal = new pc.Vec2( i2737[10], i2737[11] )
  i2736.MaxHorizontal = new pc.Vec2( i2737[12], i2737[13] )
  i2736.MinVertical = new pc.Vec2( i2737[14], i2737[15] )
  i2736.MaxVertical = new pc.Vec2( i2737[16], i2737[17] )
  i2736.IsAnchored = !!i2737[18]
  i2736.IsDebug = !!i2737[19]
  i2736.CopyHorizontal = !!i2737[20]
  i2736.CopyVertical = !!i2737[21]
  return i2736
}

Deserializers["Point"] = function (request, data, root) {
  var i2738 = root || request.c( 'Point' )
  var i2739 = data
  return i2738
}

Deserializers["PeopleContainer"] = function (request, data, root) {
  var i2740 = root || request.c( 'PeopleContainer' )
  var i2741 = data
  var i2743 = i2741[0]
  var i2742 = new (System.Collections.Generic.List$1(Bridge.ns('People')))
  for(var i = 0; i < i2743.length; i += 2) {
  request.r(i2743[i + 0], i2743[i + 1], 1, i2742, '')
  }
  i2740.CurrentPeoples = i2742
  var i2745 = i2741[1]
  var i2744 = new (System.Collections.Generic.List$1(Bridge.ns('People')))
  for(var i = 0; i < i2745.length; i += 2) {
  request.r(i2745[i + 0], i2745[i + 1], 1, i2744, '')
  }
  i2740._peoples = i2744
  request.r(i2741[2], i2741[3], 0, i2740, '_tutorialPeople')
  request.r(i2741[4], i2741[5], 0, i2740, '_spawnPoint')
  request.r(i2741[6], i2741[7], 0, i2740, '_point1')
  request.r(i2741[8], i2741[9], 0, i2740, '_point2')
  request.r(i2741[10], i2741[11], 0, i2740, '_endPoint')
  request.r(i2741[12], i2741[13], 0, i2740, '_juiceConfig')
  request.r(i2741[14], i2741[15], 0, i2740, '_tutorial')
  return i2740
}

Deserializers["UnityEngine.UI.ContentSizeFitter"] = function (request, data, root) {
  var i2748 = root || request.c( 'UnityEngine.UI.ContentSizeFitter' )
  var i2749 = data
  i2748.m_HorizontalFit = i2749[0]
  i2748.m_VerticalFit = i2749[1]
  return i2748
}
...
Deserializers["Order"] = function (request, data, root) {
  ...
  request.r(i2755[15], i2755[16], 0, i2754, '_iceButton')
  request.r(i2755[17], i2755[18], 0, i2754, '_grassButton')
  request.r(i2755[19], i2755[20], 0, i2754, '_juiceBallsButton')
  request.r(i2755[21], i2755[22], 0, i2754, '_strawButton')
  request.r(i2755[23], i2755[24], 0, i2754, '_bigCupButton')
  request.r(i2755[25], i2755[26], 0, i2754, '_middleCupButton')
  request.r(i2755[27], i2755[28], 0, i2754, '_smallCupButton')
  request.r(i2755[29], i2755[30], 0, i2754, '_appleButton')
  request.r(i2755[31], i2755[32], 0, i2754, '_orangeButton')
  request.r(i2755[33], i2755[34], 0, i2754, '_multifruitButton')
  request.r(i2755[35], i2755[36], 0, i2754, '_tomatoButton')
  request.r(i2755[37], i2755[38], 0, i2754, '_cherryButton')
  request.r(i2755[39], i2755[40], 0, i2754, '_smallRawJuiceImage')
  request.r(i2755[41], i2755[42], 0, i2754, '_middleRawJuiceImage')
  request.r(i2755[43], i2755[44], 0, i2754, '_bigRawJuiceImage')
  request.r(i2755[45], i2755[46], 0, i2754, '_smallReadyJuiceImage')
  request.r(i2755[47], i2755[48], 0, i2754, '_middleReadyJuiceImage')
  request.r(i2755[49], i2755[50], 0, i2754, '_bigReadyJuiceImage')
  request.r(i2755[51], i2755[52], 0, i2754, '_backImage')
  request.r(i2755[53], i2755[54], 0, i2754, '_aheadImage')
  request.r(i2755[55], i2755[56], 0, i2754, '_config')
  request.r(i2755[57], i2755[58], 0, i2754, '_takeOrderButton')
  request.r(i2755[59], i2755[60], 0, i2754, '_peopleContainer')
  request.r(i2755[61], i2755[62], 0, i2754, '_tutorial')
  request.r(i2755[63], i2755[64], 0, i2754, '_bText')
  request.r(i2755[65], i2755[66], 0, i2754, '_mText')
  request.r(i2755[67], i2755[68], 0, i2754, '_sText')
  request.r(i2755[69], i2755[70], 0, i2754, '_garbageButton')
  request.r(i2755[71], i2755[72], 0, i2754, '_clickSound')
  request.r(i2755[73], i2755[74], 0, i2754, '_juiceSound')
  return i2754
}
...
Deserializers["Tutorial"] = function (request, data, root) {
  ...
  request.r(i2757[9], i2757[10], 0, i2756, 'Finger5')
  request.r(i2757[11], i2757[12], 0, i2756, 'BuyBigCupFinger')
  request.r(i2757[13], i2757[14], 0, i2756, 'BuyJuiceFinger')
  request.r(i2757[15], i2757[16], 0, i2756, 'SmallCupButton')
  request.r(i2757[17], i2757[18], 0, i2756, 'JuiceButton')
  request.r(i2757[19], i2757[20], 0, i2756, 'StrawButton')
  request.r(i2757[21], i2757[22], 0, i2756, 'AdditiveButton')
  request.r(i2757[23], i2757[24], 0, i2756, 'ReadyButton')
  var i2759 = i2757[25]
  var i2758 = []
  ...
  i2756.Buttons = i2758
  request.r(i2757[26], i2757[27], 0, i2756, 'Bank')
  return i2756
}
...
Deserializers["ClickCta"] = function (request, data, root) {
  var i2764 = root || request.c( 'ClickCta' )
  var i2765 = data
  return i2764
}
...
Deserializers["Helper"] = function (request, data, root) {
  ...
  request.r(i2775[27], i2775[28], 0, i2774, '_peoples')
  request.r(i2775[29], i2775[30], 0, i2774, '_tutorial')
  request.r(i2775[31], i2775[32], 0, i2774, '_order')
  request.r(i2775[33], i2775[34], 0, i2774, '_strawButton')
  request.r(i2775[35], i2775[36], 0, i2774, '_bigCupButton')
  request.r(i2775[37], i2775[38], 0, i2774, '_middleCupButton')
  request.r(i2775[39], i2775[40], 0, i2774, '_smallCupButton')
  request.r(i2775[41], i2775[42], 0, i2774, '_readyButton')
  request.r(i2775[43], i2775[44], 0, i2774, '_grassButton')
  request.r(i2775[45], i2775[46], 0, i2774, '_juiceballButton')
  request.r(i2775[47], i2775[48], 0, i2774, '_iceButton')
  request.r(i2775[49], i2775[50], 0, i2774, '_touchIdleTimer')
  request.r(i2775[51], i2775[52], 0, i2774, '_finalScreen')
  return i2774
}
...
Deserializers.creativeName = "DefaultVersion52";
...
Deserializers.buildID = "e1753ee1-189a-4d9b-9a2a-ebd1c0866635";
